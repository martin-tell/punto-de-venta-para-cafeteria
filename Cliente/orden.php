            ...
            <div class="row g-5">
                <div class="col-md-5 col-lg-4 order-md-last">
                    <h4 class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <span class="badge bg-primary rounded-pill" id="num_products">0</span>
                    </h4>
                    <ul class="list-group mb-3" id="order"></ul>
                ...
                <div class="col-md-7 col-lg-8">
                    ...
                    <form class="needs-validation" novalidate id="address-payment">
                        <div class="row g-3">
                            <div class="col-sm-6">
                                <label for="firstName" class="form-label">Calle </label>
                                <input type="text" class="form-control" name="street" placeholder="" value="">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="address_number" placeholder="" value="">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                ...
                                <input type="email" class="form-control" name="postal_code">
                                <div class="invalid-feedback">
                        ...
                        <div class="my-3">
                            <div class="form-check">
                                <input id="cash" name="paymentMethod" type="radio" class="form-check-input" value="Efectivo" checked required>
                                <label class="form-check-label" for="credit">En efectivo <span class="text-body-secondary">(Al llegar el pedido)</span></label>
                            </div>
                            <div class="form-check">
                        ...
                        <button class="w-100 btn btn-primary btn-lg" type="submit" id="command">Realizar Pedido</button>
                    </form>
                </div>
            </div>
